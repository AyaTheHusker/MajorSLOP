...
a = Analysis(
    ['Z:\\home\\user\\AI\\mudproxy\\mudproxy-gui\\__main__.py'],
    pathex=['Z:\\home\\user\\AI\\mudproxy', 'Z:\\home\\user\\AI\\mudproxy\\mudproxy-web'],
    binaries=[],
    datas=[('Z:\\home\\user\\AI\\mudproxy\\mudproxy-web\\static', 'static'), ('Z:\\home\\user\\AI\\mudproxy\\scripts', 'scripts')],
